...
const RightHero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden ">
      ...
      <div className="container mx-auto px-8 pt-20  relative z-10 animation-delay-100">
        <div className="space-y-8">
          ...
          <div className="space-y-4  ">
            <h1 className="text-5xl md:text-6xl mt-17 lg:text-7xl font-bold animate-fade-in animation-delay-300">
              Crafting{" "}
            ...
            <p className="    text-md text-muted-foreground mx-w-lg  my-12 animate-fade-in animation-delay-700">
              Hi, I'm{" "}
              ...
              <br />
              and TypeScript. I build efficient, scalable, and user-focused web
              applications that user love.
            </p>
          </div>
          {/* ----- button section---  */}
          ...
          <div className="flex items-center justify-center pt-5 gap-2 animate-fade-in ">
